...
def get_surfaces_for_load(
    ...
    gbs_surf = a.Surface(
        side1Faces=inst_gbs.faces[:],
        name='GBS_Surface'
    )

    # pipe_surf = a.Surface(
    #     side1Faces=inst_gbs.faces[:],
    #     name='Pipe_Top_Surface'
    # )

    

    # # Création surfaces
    # a.Set(name='Pipe_Contact_Surface', faces=inst_pipe.faces[:])
    # a.Set(name='GBS_Surface', faces=inst_gbs.faces[:])

    return 'Pipe_Top_Surface', 'GBS_Surface'
